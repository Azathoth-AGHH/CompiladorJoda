...
public class AnalizadorSemantico {
    ...
    private void analizarDefine(NodoAST.NodoDefine nodo) {
        ...
        if (nodo.expresion != null) {
            // Si el tipo es OBJECT, aceptar cualquier expresion (new, llamadas, etc.)
            if (tipo == EntradaTablaSimbolos.TipoDato.OBJECT) {
                analizarExpresionConTipo(nodo.expresion); // registrar uso sin validar tipo
            } else {
